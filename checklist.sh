...
ssh-rsa  naina.gupta@gravitontrading.com
...
`{ crontab -l -u trading 2>/dev/null; echo  '30 5 * * * (sudo date -s "$(curl -sD - google.com | grep ^Date: | cut -d'"'"' '"'"' -f3-6)Z" && sudo hwclock --systohc) > /tmp/time_sync.out'; } | uniq - | crontab -u trading -`
...
echo
cat /etc/sysctl.d/10-hugepages.conf | grep vm.nr_hugepages=2048
if [ $? -ne 0 ] ; then
